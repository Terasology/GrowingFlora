...
public class AdvancedStagesGrowthDefinition implements PlantGrowthDefinition {
    ...
    private final Function<LocalParameters, Long> growthTimeFunction;
    private final List<BlockUri> plantStages;
    private final Predicate<LocalParameters> deathCondition;
    private final BlockUri deadPlantBlock;

    public AdvancedStagesGrowthDefinition(String plantId, Predicate<LocalParameters> spawnCondition,
                                          Function<LocalParameters, Long> growthTimeFunction,
                                          List<BlockUri> plantStages,
